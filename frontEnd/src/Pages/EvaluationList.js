                        ...
                        <tbody>
                            {students.map((student, index) => (
                                <tr key={index} className="table-row">
                                    ...
                                    <td style={Math.trunc((student.attendence_till / student.attendence_total) * 100) < 75 ? { color: 'red' } : { color: 'black' }}>
                                        {Math.trunc((student.attendence_till / student.attendence_total) * 100)}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
