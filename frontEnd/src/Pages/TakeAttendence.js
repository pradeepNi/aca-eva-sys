...
const Attendence = () => {
    ...
    return (
        <>
            <button className="submit" onClick={(e) => SubmitHandler(e)}>{toggleSubmit ? <Spinner animation="border" role="status">
                <span className="visually-hidden">Loading...</span>
            </Spinner>: <span className="visually-hidden">SUBMIT</span> }</button>
                            ...
                            {students.map((student, index) => (
                                <tr key={index} className="table-row">
                                    ...
                                    <td className="absent-present">
                                        <Attend onClick={(e) => clickHandler(e, index, true)}>P</Attend>
                                        <Attend onClick={(e) => clickHandler(e, index, false)}>A</Attend>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
